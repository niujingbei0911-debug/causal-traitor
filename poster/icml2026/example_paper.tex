...
judge-style baselines, while a deliberately leaking positive control shows how
oracle information can inflate benchmark scores. These results support the
need for public/gold partitioning in causal oversight benchmarks; larger
synthetic runs, real-grounded cases, API-based model baselines, and human audit
remain required before claiming a mature benchmark release.
\end{abstract}
...
$\mathbb{E}[\text{Acc}(V_{\text{leak}})] \ge
 \mathbb{E}[\text{Acc}(V_{\text{public}})]$ for an oracle-positive-control
verifier that can decode label signal from $g$, with strict inequality
whenever the decoded signal changes at least one expected error of
$V_{\text{public}}$ into a correct prediction.
\end{proposition}
...
repository state, but they are not a saturation study: the synthetic core is
still modest, the leakage study is exploratory because it uses ten rather than
the pre-registered sixty samples per family, and the real-grounded, human-audit
and API-based model-baseline phases are not yet complete. We therefore present
the empirical results as fixed-code evidence for the benchmark contract and
...
\midrule
\textsc{Direct Judge}          & test\_iid & $0.504 \pm 0.090$ & $0.889 \pm 0.192$ & $0.500 \pm 0.500$ \\
\textsc{Direct Judge}          & test\_ood & $0.161 \pm 0.056$ & $0.970 \pm 0.029$ & $0.184 \pm 0.034$ \\
\textsc{CoT Judge}             & test\_iid & $0.322 \pm 0.019$ & $0.000 \pm 0.000$ & $1.000 \pm 0.000$ \\
\textsc{CoT Judge}             & test\_ood & $0.592 \pm 0.053$ & $0.000 \pm 0.000$ & $1.000 \pm 0.000$ \\
\textsc{Tool Baseline}         & test\_iid & $0.54 \pm 0.12$ & $0.37 \pm 0.26$ & $0.67 \pm 0.58$ \\
\textsc{Tool Baseline}         & test\_ood & $0.346 \pm 0.092$ & $0.423 \pm 0.057$ & $0.560 \pm 0.067$ \\
\textsc{Debate Baseline}       & test\_iid & $0.322 \pm 0.019$ & $0.000 \pm 0.000$ & $1.000 \pm 0.000$ \\
\textsc{Debate Baseline}       & test\_ood & $0.456 \pm 0.040$ & $0.000 \pm 0.000$ & $0.610 \pm 0.026$ \\
\textsc{Refusal-Aware}         & test\_iid & $0.752 \pm 0.045$ & $0.000 \pm 0.000$ & $1.000 \pm 0.000$ \\
\textsc{Refusal-Aware}         & test\_ood & $0.504 \pm 0.090$ & $0.000 \pm 0.000$ & $0.591 \pm 0.020$ \\
\textsc{Countermodel-Grounded} & test\_iid & $1.000 \pm 0.000$ & $0.000 \pm 0.000$ & $1.000 \pm 0.000$ \\
\textsc{Countermodel-Grounded} & test\_ood & $0.891 \pm 0.005$ & $0.000 \pm 0.000$ & $0.825 \pm 0.018$ \\
\bottomrule
\end{tabular}
\end{sc}
\end{small}
...
recall and substantially improving raw verdict accuracy over public judge-style
baselines.
...
\midrule
\textsc{Full}            & iid & $1.000$ & $1.000$ \\
\textsc{Full}            & ood & $0.891$ & $0.825$ \\
\textsc{No-Ledger}       & iid & $0.144$ & $1.000$ \\
\textsc{No-Ledger}       & ood & $0.520$ & $1.000$ \\
\textsc{No-Countermodel} & iid & $0.752$ & $1.000$ \\
\textsc{No-Countermodel} & ood & $0.504$ & $0.591$ \\
\textsc{No-Abstention}   & iid & $0.856$ & $0.000$ \\
\textsc{No-Abstention}   & ood & $0.462$ & $0.000$ \\
\textsc{No-Tools}        & iid & $0.570$ & $1.000$ \\
\textsc{No-Tools}        & ood & $0.911$ & $0.964$ \\
\bottomrule
\end{tabular}
}
\end{sc}
...
\midrule
Accuracy             & $0.579$ & $1.000$ & $+0.421$ \\
Macro-F1             & $0.373$ & $0.667$ & $+0.294$ \\
ECE ($\downarrow$)   & $0.400$ & $0.000$ & $-0.400$ \\
Brier ($\downarrow$) & $0.220$ & $0.000$ & $-0.220$ \\
\midrule
Metric (test\_ood) & Clean & Leaking & $\Delta$ \\
\midrule
Accuracy             & $0.845$ & $1.000$ & $+0.155$ \\
Macro-F1             & $0.563$ & $0.667$ & $+0.104$ \\
ECE ($\downarrow$)   & $0.077$ & $0.000$ & $-0.077$ \\
Brier ($\downarrow$) & $0.086$ & $0.000$ & $-0.086$ \\
\bottomrule
\end{tabular}
\end{sc}
\end{small}
...
\midrule
\textsc{Weak}                       & iid & $0.889 \pm 0.192$ & $0.667 \pm 0.577$ \\
\textsc{Weak}                       & ood & $0.845 \pm 0.039$ & $0.685 \pm 0.082$ \\
\textsc{Medium}                     & iid & $0.889 \pm 0.192$ & $0.667 \pm 0.577$ \\
\textsc{Medium}                     & ood & $0.845 \pm 0.039$ & $0.685 \pm 0.082$ \\
\textsc{Strong}                     & iid & $0.889 \pm 0.192$ & $0.667 \pm 0.577$ \\
\textsc{Strong}                     & ood & $0.845 \pm 0.039$ & $0.685 \pm 0.082$ \\
\textsc{Leak-Aware}                 & iid & $0.579 \pm 0.417$ & $0.667 \pm 0.577$ \\
\textsc{Leak-Aware}                 & ood & $0.845 \pm 0.067$ & $0.844 \pm 0.104$ \\
\bottomrule
\end{tabular}
}
\end{sc}
...
snapshot. A paper-facing reproducibility package will be released after the
real-grounded subset, human audit, and API-model baseline runs are completed.
Each experiment emits a configuration JSON, a seed list, raw per-sample
predictions, an aggregated metrics file, $95\%$ CIs, paired-significance tests,
and a markdown summary. The leakage study additionally emits a leakage-warning
