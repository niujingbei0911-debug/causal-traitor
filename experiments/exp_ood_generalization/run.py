    ...
    for seed in resolved_seeds:
        ...
        for bucket_name, expected_reason, split_kwargs in PRIMARY_OOD_BUCKETS:
            run = build_seed_benchmark_run(
                ...
                mechanism_holdout=split_kwargs["mechanism_holdout"],
                attack_family_holdout=split_kwargs["attack_family_holdout"],
                context_shift_holdout=split_kwargs["context_shift_holdout"],
                paired_flip_holdout=split_kwargs["paired_flip_holdout"],
            )
